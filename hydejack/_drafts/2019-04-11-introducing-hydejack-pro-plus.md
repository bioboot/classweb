---
title: Introducing Hydejack PRO+
# image: /assets/img/blog/wade-lambert.jpg
description: >
  Hydejack 9.0.0-alpha.1 introduces new options to bring Hydejack's build time in line with other Jekyll themes. 
---
...
Staring with version 9.0.0-alpha.1, you can define sidebar entries in the config file under the `menu` key like so:
...
Note that the old way of doing things still works if you upgrade to 9.0.0-alpha.1. Only when you set the `menu` key will Hydejack switch to the new behavior.
{:.message}
